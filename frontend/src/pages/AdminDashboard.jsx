  ...
  return (
    <Box>
      ...
      <Grid container spacing={2} sx={{ mb: 3 }}>
        {[
          { title: 'Total Leads', value: kpis?.totalLeads, icon: <Business />, color: '#1976d2', onClick: () => navigateToLeads({}) },
          ...
          { title: 'Total Agents', value: kpis?.totalAgents, icon: <People />, color: '#7b1fa2', onClick: () => navigate('/admin/agents') },
